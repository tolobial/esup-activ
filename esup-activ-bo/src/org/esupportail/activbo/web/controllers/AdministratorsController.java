...
public class AdministratorsController extends AbstractContextAwareController implements LdapSearchCaller {
	...
	/**
	 * @see org.esupportail.activbo.web.controllers.AbstractContextAwareController#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @see org.esupportail.activbo.web.controllers.AbstractContextAwareController#reset()
	 */
	@Override
	public void reset() {
		super.reset();
