...
<e:page stringsVar="msgs" menuItem="account" locale="#{sessionController.locale}" >
	...
	<t:htmlTag styleClass="processSteps" value="ul">
		...
		<t:htmlTag styleClass="currentTab" value="li"><e:paragraph escape="false" value="#{msgs['ACTIVATION.COMPTE.ETAPE4.TEXT']}"/></t:htmlTag>
	</t:htmlTag>
	</t:div>
	...
	<t:htmlTag styleClass="processSteps" value="ul">
		...
		<t:htmlTag styleClass="currentTab" value="li"><e:paragraph escape="false" value="#{msgs['IDENTIFICATION.REINITIALISATION.ETAPE5.TEXT']}"/></t:htmlTag>
	</t:htmlTag>
	</t:div>
	...
	<t:htmlTag styleClass="processSteps" value="ul">
		...
		<t:htmlTag styleClass="currentTab" value="li"><e:paragraph escape="false" value="#{msgs['IDENTIFICATION.PASSWORDCHANGE.ETAPE3.TEXT']}"/></t:htmlTag>
	</t:htmlTag>
	</t:div>
